...
Eerlijke verdeling van weekendpoetsbeurten voor ouders van Steinerschool Gent.

## Wat doet het?

Aan het begin van het schooljaar ontvangt elke ouder een overzicht van de weekenden waarop ze de klas van hun kind poetsen. Poetser genereert dat rooster automatisch op basis van een leerlingenlijst, met twee verdeelmethoden en aandacht voor gezinnen met meerdere kinderen op school.

## Functies

- **Import** van leerlingenlijst via `.xlsx`, `.xls` of `.csv` — kolomtoewijzing via drag-and-drop interface
- **Klassenbeheer** met automatische sortering (Peuter → Kleuter → Lager) en handmatige volgorde via pijltjes
